...
import PreNominationPp from '../components/PreNominationPp.js';
import { Page, Center } from '../components/layout/Layout.js';
import { DrizzleContext } from "@drizzle/react-plugin";
import {  Loader } from 'rimble-ui';

export default class PreDnaPage extends Component {
                        ...
                        if(!initialized) {
                          ...
                          return(
                            <Container fluid className="d-flex justify-content-center main-container-pp">                               
                              <PreNominationPp  drizzleState={drizzleState} drizzle={drizzle}  />
                            </Container>
                          )
                       }
                      }  
