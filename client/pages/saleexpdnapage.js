...
import ExpSaleDna from "../components/ExpSaleDna.js";

export default class ExpiredSalePage extends Component {
                        ...
                        if(!initialized) {
                          ...
                          return(                               
                            <Container fluid className="d-flex justify-content-center main-container-pp">  
                              <ExpSaleDna drizzleState={drizzleState} drizzle={drizzle}  />
                            </Container>  
                          )
                       }
                      }  
