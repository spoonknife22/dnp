...
import NominatedCardsExpired from "./cards/ExpiredNomCards.js";
...
class PurchaseProtocalExpired extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      manaBalance:null
  ...
  async componentDidMount() {   
    ...
    const userManaBalanceOriginal = web3.utils.fromWei(`${userManaBalanceConvert}`);
...
export default connect(mapStateToProps, null)(PurchaseProtocalExpired);
