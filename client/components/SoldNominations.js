...
import CardFooterBtn from './buttons/CardFooterBtn.js';

const SoldNominations =  ({ orders, loading, props, userManaBalance }) => {
  if (loading) {
    return (
  ...
  return (  
    <Row className="mt-4 justify-content-center">
      {orders.map(parcel => (
          <div key={parcel.id} className="mb-4 col-sm-12 col-md-12 col-lg-4 nominations-main-col" >
            <Card>
              ...
              <div>
                <div>
                  <CardTitle className="asset-title text-center">
                    <div className="current-price">DNA Sold</div>
                  </CardTitle>   
                </div>  
              </div>  
...
export default connect(null, null)(SoldNominations);