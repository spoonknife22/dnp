...
import PreNominatedAssetCards from "./cards/PreNominatedAssetCards.js";
import Web3 from "web3";

let web3 = new Web3(Web3.givenProvider);

class PreNominationPp extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      manaBalance:null
...
export default connect(mapStateToProps, mapDispatchToProps)(PreNominationPp);
