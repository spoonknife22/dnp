...
const PurchaseModal= ({ props, orderId, storedOrderId, prevOrderStatus, userManaBalance, nftAddress, expiresAt, assetPrice, tokenId }) => {
...
export default connect(null, mapDispatchToProps)(PurchaseModal);
